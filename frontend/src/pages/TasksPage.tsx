...
import { cancelTask, createTask, getTaskEvents, subscribeToTaskEvents } from '../api/tasks'
  ...
  useEffect(() => {
    ...
    const stop = subscribeToTaskEvents(selectedTaskId, (event) => {
      setEventsByTask((current) => {
        ...
        updateTaskStatus(selectedTaskId, taskStatus(next))
